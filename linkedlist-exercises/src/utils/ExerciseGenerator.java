...
public class ExerciseGenerator {
    ...
    public static void main(String[] args) throws IOException {
        File exercises = new File("./linkedlist-exercises/src/exercises");
        ...
        //README.md
        String solution = "https://www.w3resource.com/java-exercises/collection/java-collection-linked-list-exercise-" + newExerciseOrder + ".php";
        HashMap<String, String> data = fetchExerciseData(solution);
        String content = "###[Java Math: Exercise-" + newExerciseOrder + "](" + solution + ")\n***\n" +
                data.get("statement") +
                "\n\n***\n" +
                "_Sample output:_\n" +
                data.get("sampleOutput");
        String url = "./linkedlist-exercises/src/exercises/exercise" + newExerciseOrder;
        new File(url).mkdirs();
        url += "/README.md";
        ...
        content = "package exercises.exercise" + newExerciseOrder + ";\n\n" +
                ...
                "    }\n}";
        url = "./linkedlist-exercises/src/exercises/exercise" + newExerciseOrder + "/Exercise" + newExerciseOrder + ".java";
    ...
    private static HashMap<String, String> fetchExerciseData(String exercise) throws IOException {
        ...
        String p = "<p>Write a Java ";
        String pWithSpace = "<p> Write a Java ";
        ;
