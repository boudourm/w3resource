...
public class ExerciseGenerator {
    ...
    public static void main(String[] args) throws IOException {
        File exercises = new File("./data-type-exercises/src/exercises");
        ...
        String content = "###[Java Datatype: Exercise-" + newExerciseOrder + "](" + solution + ")\n***\n" +
                data.get("statement") +
                "\n\n***\n" +
                "_Sample output:_\n" +
                data.get("sampleOutput");
        String url = "./data-type-exercises/src/exercises/exercise" + newExerciseOrder;
        new File(url).mkdirs();
        url += "/README.md";
        ...
        content = "package exercises.exercise" + newExerciseOrder + ";\n\n" +
                ...
                "    }\n}";
        url = "./data-type-exercises/src/exercises/exercise" + newExerciseOrder + "/Exercise" + newExerciseOrder + ".java";
