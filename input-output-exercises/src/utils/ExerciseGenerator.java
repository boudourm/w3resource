...
public class ExerciseGenerator {
    ...
    public static void main(String[] args) throws IOException {
        File exercises = new File("./input-output-exercises/src/exercises");
        ...
        //README.md
        String solution = "https://www.w3resource.com/java-exercises/io/java-io-exercise-" + newExerciseOrder + ".php";
        HashMap<String, String> data = fetchExerciseData(solution);
        String content = "###[Java Input-Output: Exercise-" + newExerciseOrder + "](" + solution + ")\n***\n" +
                data.get("statement") +
                "\n\n***\n" +
                "_Sample output:_\n" +
                data.get("sampleOutput");
        String url = "./input-output-exercises/src/exercises/exercise" + newExerciseOrder;
        new File(url).mkdirs();
        url += "/README.md";
        ...
        content = "package exercises.exercise" + newExerciseOrder + ";\n\n" +
                ...
                "    }\n}";
        url = "./input-output-exercises/src/exercises/exercise" + newExerciseOrder + "/Exercise" + newExerciseOrder + ".java";
