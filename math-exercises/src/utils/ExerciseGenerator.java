...
public class ExerciseGenerator {
    ...
    public static void main(String[] args) throws IOException {
        File exercises = new File("./math-exercises/src/exercises");
        ...
        //README.md
        String solution = "https://www.w3resource.com/java-exercises/math/java-math-exercise-" + newExerciseOrder + ".php";
        ...
        String url = "./math-exercises/src/exercises/exercise" + newExerciseOrder;
        new File(url).mkdirs();
        url += "/README.md";
        ...
        content = "package exercises.exercise" + newExerciseOrder + ";\n\n" +
                ...
                "    }\n}";
        url = "./math-exercises/src/exercises/exercise" + newExerciseOrder + "/Exercise" + newExerciseOrder + ".java";
